            ...
            <div class="content-body">
                ...
                <div class="row">
                    ...
                    <div id="divModAdmin" style="display: none;">
                        ...
                        <div id="ARRSDivId" style="display: none;" class="col-xl-3 col-lg-6 col-xs-12">
                            <a href="../ARRS">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="card-block">
                        ...
                        <div id="SecRepoDivId" style="display: none;" class="col-xl-3 col-lg-6 col-xs-12">
                            <a href="../online_sec_repository">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="card-block">
                                            <div class="media">
                                                <div class="media-body text-xs-left">
                                                    <!-- <h3 class="deep-orange">0</h3> -->
                                                    <span>Online Secretariat Repository</span>
                                                </div>
                                                <div class="media-right media-middle">
                                                    <i class="icon-paper deep-purple font-large-2 float-xs-right"></i>
                                                </div>
                    ...
                    <div id="MPRSDivId" style="display: none;" class="col-xl-3 col-lg-6 col-xs-12">
                        <a href="../mprs">
                            <div class="card">
                                <div class="card-body">
                                    <div class="card-block">
                    ...
                    <div id="ForkliftRequestDivId" style="display: none;" class="col-xl-3 col-lg-6 col-xs-12">
                        <a href="../forklift_request/">
                            <div class="card">
                                <div class="card-body">
                                    <div class="card-block">
                                        <div class="media">
                                            <div class="media-body text-xs-left">
                                                <!-- <h3 class="deep-orange">0</h3> -->
                                                <span>Forklift Request System</span>
                                            </div>
                                            <div class="media-right media-middle">
                                                {{-- <i class="fa fa-truck pink font-large-2 float-xs-right"></i> --}}
                                                <img src="{{ asset('public/images/forklift.png') }}" width="45" height="40">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div id="FETLSDivId" style="display: none;" class="col-xl-3 col-lg-6 col-xs-12">
                        <a href="../FETLS/">
                            <div class="card">
                                <div class="card-body">
                                    <div class="card-block">
                                        <div class="media">
                                            <div class="media-body text-xs-left">
                                                <span>Facility Equipment Trouble Log System</span>
                                            </div>
                                            <div class="media-right media-middle">
                                                <i class="icon-data red font-large-2 float-xs-right"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    {{-- <div id="VTS" style="display: block;" class="col-xl-3 col-lg-6 col-xs-12">
                        <a href="../vue_ticketing_system/">
                            <div class="card">
                                <div class="card-body">
                                    <div class="card-block">
                                        <div class="media">
                    ...
                    <div id="divModQADAdmin" style="display: none;">
                        ...
                        <div id="ARRSDivId1" style="display: none;" class="col-xl-3 col-lg-6 col-xs-12">
                            <a href="../ARRS">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="card-block">
                        ...
                        <div id="SecRepoDivId1" style="display: none;" class="col-xl-3 col-lg-6 col-xs-12">
                            <a href="../online_sec_repository">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="card-block">
                        ...
                        <div id="MPRSDivId1" style="display: none;" class="col-xl-3 col-lg-6 col-xs-12">
                            <a href="../mprs">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="card-block">
                        ...
                        <div id="ForkliftRequestDivId1" style="display: none;" class="col-xl-3 col-lg-6 col-xs-12">
                            <a href="../forklift_request/">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="card-block">
                                            <div class="media">
                                                ...
                                                <div class="media-right media-middle">
                                                    {{-- <i class="icon-foklift blue font-large-2 float-xs-right"></i> --}}
                                                    <img src="{{ asset('public/images/forklift.png') }}" width="45" height="40">
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div id="FETLSDivId1" style="display: none;" class="col-xl-3 col-lg-6 col-xs-12">
                            <a href="../FETLS/">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="card-block">
