						  ...
						  <div class="card-body collapse in">
							  <div class="card-block">
								  <div style="float: right;">
									<button class="btn btn-success" id="btnShowAddUserModal" data-toggle="modal" data-target="#modalAddUser" data-keyboard="false"><i class="icon-person-add"></i> Add User</button>
								  </div>
									<br><br>
				...
				<div class="modal-body">
					<div class="form-body">
						<div class="form-group">
							...
							<input type="text" id="empNumber" class="form-control" placeholder="Employee No." name="employee_number">
						</div>
...
@section('js_content')
	<script type="text/javascript">
		...
		$(document).ready(function(){
            ...
            $('#empNumber').keyup(delay(function(e){
                    const empNumber = $('#empNumber').val();
                    $.ajax({
                        type: "get",
                        url: "get_hris_information",
                        data: {
                            "emp_no" : empNumber
                        },
                        dataType: "json",
