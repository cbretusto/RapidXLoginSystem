...
<div data-scroll-to-active="true" class="main-menu menu-fixed menu-dark menu-accordion menu-shadow">
    ...
    <div class="main-menu-content">
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
            ...
            <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
                <li class=" nav-item"><a href="department"><i class="icon-cube"></i><span
                            data-i18n="nav.bootstrap_tables.table_basic" class="menu-title">Department</span></a>
                </li>
            </ul>
            <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
                <li class="nav-item"><a href="module"><i class="icon-tasks"></i><span
                            data-i18n="nav.bootstrap_tables.table_basic" class="menu-title">Module</span></a>
                </li>
            </ul>
            <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
                <li class="nav-item"><a href="user_access"><i class="icon-user"></i><span
                            data-i18n="nav.bootstrap_tables.table_basic" class="menu-title">User Access</span></a>
                </li>
            </ul>
                ...
                <ul id="main-menu-navigation" data-menu="icon-paper" class="navigation navigation-main">
                    <li class="nav-item">
                        {{-- <a href="../Jsox/"><i class="icon-bar-chart"></i> --}}
                            ...
                            <span data-i18n="nav.bootstrap_tables.table_basic" class="menu-title">&nbsp;&nbsp;JSOX Database System</span>
                        </a>
                    </li>
                </ul>
            </div>
            ...
            <div id="ARRSId" style="display: none;">
                <ul id="main-menu-navigation" data-menu="icon-paper" class="navigation navigation-main">
                    <li class="nav-item">
                        <a href="../ARRS/"><i class="icomoon icon-paper"></i>
                            <span data-i18n="nav.bootstrap_tables.table_basic" class="menu-title">ARRS</span>
                        </a>
                    </li>
                </ul>
            </div>

            <div id="OnlineSecRepoId" style="display: none;">
                <ul id="main-menu-navigation" data-menu="icon-paper" class="navigation navigation-main">
                    <li class="nav-item">
                        <a href="../online_sec_repository/"><i class="icomoon icon-paper"></i>
                            <span data-i18n="nav.bootstrap_tables.table_basic" class="menu-title">Online Secretariat Repository</span>
                        </a>
                    </li>
                </ul>
            </div>
            ...
            <div id="MPRSId" style="display: none;">
                <ul id="main-menu-navigation" data-menu="icon-paper" class="navigation navigation-main">
                    <li class="nav-item">
                        <a href="../mprs/"><i class="icomoon icon-paper"></i>
                            <span data-i18n="nav.bootstrap_tables.table_basic" class="menu-title">MPRS</span>
                        </a>
                    </li>
                </ul>
            </div>

            <div id="ForkliftRequestId" style="display: none;">
                <ul id="main-menu-navigation" data-menu="icon-paper" class="navigation navigation-main">
                    <li class="nav-item">
                        {{-- <a href="../forklift_request"><i class="fa fa-truck"></i> --}}
                        <a href="../forklift_request/"><img src="{{ asset('public/images/forklift1.png') }}" width="20" height="22">
                            <span data-i18n="nav.bootstrap_tables.table_basic" class="menu-title">Forklift Request System</span>
                        </a>
                    </li>
                </ul>
            </div>

            <div id="FETLSId" style="display: none;">
                <ul id="main-menu-navigation" data-menu="icon-paper" class="navigation navigation-main">
                    <li class="nav-item">
                        <a href="../FETLS/"><i class="icon-data font-large-2"></i>
                            <span data-i18n="nav.bootstrap_tables.table_basic" class="menu-title">Facility Equipment <br> Trouble Log System</span>
                        </a>
                    </li>
                </ul>
            </div>
