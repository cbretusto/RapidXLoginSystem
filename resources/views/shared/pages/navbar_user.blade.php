...
<div data-scroll-to-active="true" class="main-menu menu-fixed menu-dark menu-accordion menu-shadow">
    ...
    <div class="main-menu-content">
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
            ...
            <li id="quadsnav" style="display: none;" class=" nav-item"><a href="#"><i
                        class="icon-paper"></i><span data-i18n="nav.dash.main" class="menu-title">QUADS</span>
...
<script>
    /*
        This id came from master_layout.blade.php, it is automatically passed to the txtGlobalUserId input
