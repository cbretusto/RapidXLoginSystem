...
function getUserAccess(user_level_id) {
    $.ajax({
        ...
        success: function (data) {
            ...
            if (jQuery.inArray(32, module_assigned) != -1) {
                console.log("32-ARRS");
                $("#ARRSId").css("display", '');
                $("#ARRSDivId1").css("display", '');
                $("#ARRSDivId").css("display", '');
            }

            if (jQuery.inArray(33, module_assigned) != -1) {
                console.log("33-MPRS");
                $("#MPRSId").css("display", '');
                $("#MPRSDivId1").css("display", '');
                $("#MPRSDivId").css("display", '');
            }

            // 34 - Forklift Request System
            if (jQuery.inArray(34, module_assigned) != -1) {
                console.log("34-Forklift Request is in array");
                $("#ForkliftRequestId").css("display", '');
                $("#ForkliftRequestDivId").css("display", '');
                $("#ForkliftRequestDivId1").css("display", '');
            }

            // 35 - Online Secretariat Repository
            if (jQuery.inArray(35, module_assigned) != -1) {
                console.log("35-Online Secretariat Repositoryy");
                $("#OnlineSecRepoId").css("display", '');
                $("#SecRepoDivId").css("display", '');
                $("#SecRepoDivId1").css("display", '');
            }

            // 36 - Forklift Request System
            if (jQuery.inArray(36, module_assigned) != -1) {
                console.log("36-Facility Equipment Trouble Log System is in array");
                $("#FETLSId").css("display", '');
                $("#FETLSDivId").css("display", '');
                $("#FETLSDivId1").css("display", '');
            }
